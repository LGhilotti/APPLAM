...
DEFAULT_PARAMS_FILE = "data/Student_latent_repeated_data/resources/sampler_params.asciipb"
SPECIFIC_PARAMS_FILE = "data/Student_latent_repeated_data/resources/sampler_params_p{0}_d{1}_m{2}.asciipb"
...
if __name__ == "__main__" :
    ...
    for p,d,M,npc in product(p_s, d_s, M_s, n_percluster_s):   
      ...
      outpath_d = "data/Student_latent_repeated_data/applam/app_p_{0}_dtrue_{1}_M_{2}_npc_{3}_out".format(p,d,M,npc)
