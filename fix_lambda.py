...
sigma_bar_prec = np.array([10, 0.1])
print(sigma_bar_prec)
sigma_bar_cov = 1/sigma_bar_prec



lamb = np.array([[3,0],[0,1/3]])
...
etas_1[:,1] = np.random.normal(loc = 0, scale = 0.5, size = npc)
...
etas_2[:,1] = np.random.normal(loc = 0, scale = 0.5, size = npc)
