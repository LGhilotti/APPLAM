...
////////////////////////////////////////
////// Mala Isotropic version //////////
////////////////////////////////////////
double LambdaSamplerMalaisotropic::compute_ln_dens_analytic(const MatrixXd& lamb){
...
double LambdaSamplerMalaisotropic::compute_ln_dens_analytic(){
...
MatrixXd LambdaSamplerMalaisotropic::compute_grad_analytic(const MatrixXd& lamb){

  return compute_gr_an(lamb);

}



MatrixXd LambdaSamplerMalaisotropic::compute_grad_analytic(){

  return compute_gr_an(mcmc->get_Lambda());

}


MatrixXd LambdaSamplerMalaisotropic::compute_gr_an(const MatrixXd& lamb){
...
// Ctilde is not used -> just to make perform virtual
void LambdaSamplerMalaisotropic::perform(MatrixXd& Ctilde) {
