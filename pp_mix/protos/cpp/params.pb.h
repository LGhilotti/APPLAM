...
class Params PROTOBUF_FINAL :
 ...
 public:
  ...
  enum StepMeansCase {
    kMalaStepMeans = 12,
    kMhSigmaMeans = 13,
    STEP_MEANS_NOT_SET = 0,
  };

  enum StepLambdaCase {
    kMalaStepLambda = 14,
    kMhSigmaLambda = 15,
    STEP_LAMBDA_NOT_SET = 0,
  };
  ...
  enum : int {
    ...
    kMalaStepMeansFieldNumber = 12,
    kMhSigmaMeansFieldNumber = 13,
    kMalaStepLambdaFieldNumber = 14,
    kMhSigmaLambdaFieldNumber = 15,
  };
  // .DPPParams dpp = 1;
  bool has_dpp() const;
  private:
  ...
  private:
  bool _internal_has_mala_step_means() const;
  public:
  void clear_mala_step_means();
  double mala_step_means() const;
  void set_mala_step_means(double value);
  private:
  double _internal_mala_step_means() const;
  void _internal_set_mala_step_means(double value);
  public:

  // double mh_sigma_means = 13;
  private:
  bool _internal_has_mh_sigma_means() const;
  public:
  void clear_mh_sigma_means();
  double mh_sigma_means() const;
  void set_mh_sigma_means(double value);
  private:
  double _internal_mh_sigma_means() const;
  void _internal_set_mh_sigma_means(double value);
  public:

  // double mala_step_lambda = 14;
  private:
  bool _internal_has_mala_step_lambda() const;
  public:
  void clear_mala_step_lambda();
  double mala_step_lambda() const;
  void set_mala_step_lambda(double value);
  private:
  double _internal_mala_step_lambda() const;
  void _internal_set_mala_step_lambda(double value);
  public:

  // double mh_sigma_lambda = 15;
  private:
  bool _internal_has_mh_sigma_lambda() const;
  public:
  void clear_mh_sigma_lambda();
  double mh_sigma_lambda() const;
  void set_mh_sigma_lambda(double value);
  private:
  double _internal_mh_sigma_lambda() const;
  void _internal_set_mh_sigma_lambda(double value);
  public:

  void clear_prec_params();
  PrecParamsCase prec_params_case() const;
  void clear_step_means();
  StepMeansCase step_means_case() const;
  void clear_step_lambda();
  StepLambdaCase step_lambda_case() const;
 ...
 private:
  ...
  void set_has_mala_step_means();
  void set_has_mh_sigma_means();
  void set_has_mala_step_lambda();
  void set_has_mh_sigma_lambda();

  inline bool has_prec_params() const;
  inline void clear_has_prec_params();

  inline bool has_step_means() const;
  inline void clear_has_step_means();

  inline bool has_step_lambda() const;
  inline void clear_has_step_lambda();
  ...
  union StepMeansUnion {
    StepMeansUnion() {}
    double mala_step_means_;
    double mh_sigma_means_;
  } step_means_;
  union StepLambdaUnion {
    StepLambdaUnion() {}
    double mala_step_lambda_;
    double mh_sigma_lambda_;
  } step_lambda_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
// double mala_step_means = 12;
inline bool Params::_internal_has_mala_step_means() const {
  return step_means_case() == kMalaStepMeans;
}
inline void Params::set_has_mala_step_means() {
  _oneof_case_[1] = kMalaStepMeans;
}
inline void Params::clear_mala_step_means() {
  if (_internal_has_mala_step_means()) {
    step_means_.mala_step_means_ = 0;
    clear_has_step_means();
  }
}
inline double Params::_internal_mala_step_means() const {
  if (_internal_has_mala_step_means()) {
    return step_means_.mala_step_means_;
  }
  return 0;
}
inline void Params::_internal_set_mala_step_means(double value) {
  if (!_internal_has_mala_step_means()) {
    clear_step_means();
    set_has_mala_step_means();
  }
  step_means_.mala_step_means_ = value;
}
inline double Params::mala_step_means() const {
  // @@protoc_insertion_point(field_get:Params.mala_step_means)
  return _internal_mala_step_means();
}
inline void Params::set_mala_step_means(double value) {
  _internal_set_mala_step_means(value);
  // @@protoc_insertion_point(field_set:Params.mala_step_means)
}

// double mh_sigma_means = 13;
inline bool Params::_internal_has_mh_sigma_means() const {
  return step_means_case() == kMhSigmaMeans;
}
inline void Params::set_has_mh_sigma_means() {
  _oneof_case_[1] = kMhSigmaMeans;
}
inline void Params::clear_mh_sigma_means() {
  if (_internal_has_mh_sigma_means()) {
    step_means_.mh_sigma_means_ = 0;
    clear_has_step_means();
  }
}
inline double Params::_internal_mh_sigma_means() const {
  if (_internal_has_mh_sigma_means()) {
    return step_means_.mh_sigma_means_;
  }
  return 0;
}
inline void Params::_internal_set_mh_sigma_means(double value) {
  if (!_internal_has_mh_sigma_means()) {
    clear_step_means();
    set_has_mh_sigma_means();
  }
  step_means_.mh_sigma_means_ = value;
}
inline double Params::mh_sigma_means() const {
  // @@protoc_insertion_point(field_get:Params.mh_sigma_means)
  return _internal_mh_sigma_means();
}
inline void Params::set_mh_sigma_means(double value) {
  _internal_set_mh_sigma_means(value);
  // @@protoc_insertion_point(field_set:Params.mh_sigma_means)
}

// double mala_step_lambda = 14;
inline bool Params::_internal_has_mala_step_lambda() const {
  return step_lambda_case() == kMalaStepLambda;
}
inline void Params::set_has_mala_step_lambda() {
  _oneof_case_[2] = kMalaStepLambda;
}
inline void Params::clear_mala_step_lambda() {
  if (_internal_has_mala_step_lambda()) {
    step_lambda_.mala_step_lambda_ = 0;
    clear_has_step_lambda();
  }
}
inline double Params::_internal_mala_step_lambda() const {
  if (_internal_has_mala_step_lambda()) {
    return step_lambda_.mala_step_lambda_;
  }
  return 0;
}
inline void Params::_internal_set_mala_step_lambda(double value) {
  if (!_internal_has_mala_step_lambda()) {
    clear_step_lambda();
    set_has_mala_step_lambda();
  }
  step_lambda_.mala_step_lambda_ = value;
}
inline double Params::mala_step_lambda() const {
  // @@protoc_insertion_point(field_get:Params.mala_step_lambda)
  return _internal_mala_step_lambda();
}
inline void Params::set_mala_step_lambda(double value) {
  _internal_set_mala_step_lambda(value);
  // @@protoc_insertion_point(field_set:Params.mala_step_lambda)
}

// double mh_sigma_lambda = 15;
inline bool Params::_internal_has_mh_sigma_lambda() const {
  return step_lambda_case() == kMhSigmaLambda;
}
inline void Params::set_has_mh_sigma_lambda() {
  _oneof_case_[2] = kMhSigmaLambda;
}
inline void Params::clear_mh_sigma_lambda() {
  if (_internal_has_mh_sigma_lambda()) {
    step_lambda_.mh_sigma_lambda_ = 0;
    clear_has_step_lambda();
  }
}
inline double Params::_internal_mh_sigma_lambda() const {
  if (_internal_has_mh_sigma_lambda()) {
    return step_lambda_.mh_sigma_lambda_;
  }
  return 0;
}
inline void Params::_internal_set_mh_sigma_lambda(double value) {
  if (!_internal_has_mh_sigma_lambda()) {
    clear_step_lambda();
    set_has_mh_sigma_lambda();
  }
  step_lambda_.mh_sigma_lambda_ = value;
}
inline double Params::mh_sigma_lambda() const {
  // @@protoc_insertion_point(field_get:Params.mh_sigma_lambda)
  return _internal_mh_sigma_lambda();
}
...
inline bool Params::has_step_means() const {
  return step_means_case() != STEP_MEANS_NOT_SET;
}
inline void Params::clear_has_step_means() {
  _oneof_case_[1] = STEP_MEANS_NOT_SET;
}
inline bool Params::has_step_lambda() const {
  return step_lambda_case() != STEP_LAMBDA_NOT_SET;
}
inline void Params::clear_has_step_lambda() {
  _oneof_case_[2] = STEP_LAMBDA_NOT_SET;
}
inline Params::PrecParamsCase Params::prec_params_case() const {
  return Params::PrecParamsCase(_oneof_case_[0]);
}
inline Params::StepMeansCase Params::step_means_case() const {
  return Params::StepMeansCase(_oneof_case_[1]);
}
inline Params::StepLambdaCase Params::step_lambda_case() const {
  return Params::StepLambdaCase(_oneof_case_[2]);
}
#ifdef __GNUC__
