...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_params_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::WishartParams, sigma_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 8, -1, sizeof(::FixedMultiPrecParams)},
  { 14, -1, sizeof(::FixedUnivPrecParams)},
  { 20, -1, sizeof(::GammaParams)},
  { 27, -1, sizeof(::DPPParams)},
  { 35, -1, sizeof(::Params)},
};
...
const char descriptor_table_protodef_params_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014params.proto\"<\n\rWishartParams\022\n\n\002nu\030\001 "
  "\001(\001\022\020\n\010identity\030\002 \001(\010\022\r\n\005sigma\030\003 \001(\001\"%\n\024"
  "FixedMultiPrecParams\022\r\n\005sigma\030\001 \001(\001\"$\n\023F"
  ...
  "ivPrecParamsH\000\022\"\n\ngamma_prec\030\005 \001(\0132\014.Gam"
  "maParamsH\000\022\t\n\001a\030\007 \001(\001\022\021\n\talphajump\030\010 \001(\001"
...
WishartParams::WishartParams(const WishartParams& from)
  ...
  ::memcpy(&nu_, &from.nu_,
    ...
    reinterpret_cast<char*>(&nu_)) + sizeof(identity_));
...
void WishartParams::InternalSwap(WishartParams* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(WishartParams, identity_)
      + sizeof(WishartParams::identity_)
      - PROTOBUF_FIELD_OFFSET(WishartParams, nu_)>(
...
Params::Params(const Params& from)
  ...
  switch (from.step_means_case()) {
    case kMalaStepMeans: {
      _internal_set_mala_step_means(from._internal_mala_step_means());
      break;
    }
    case kMhSigmaMeans: {
      _internal_set_mh_sigma_means(from._internal_mh_sigma_means());
      break;
    }
    case STEP_MEANS_NOT_SET: {
      break;
    }
  }
  clear_has_step_lambda();
  switch (from.step_lambda_case()) {
    case kMalaStepLambda: {
      _internal_set_mala_step_lambda(from._internal_mala_step_lambda());
      break;
    }
    case kMhSigmaLambda: {
      _internal_set_mh_sigma_lambda(from._internal_mh_sigma_lambda());
      break;
    }
    case STEP_LAMBDA_NOT_SET: {
      break;
    }
  }
...
void Params::clear_step_means() {
// @@protoc_insertion_point(one_of_clear_start:Params)
  switch (step_means_case()) {
    case kMalaStepMeans: {
      // No need to clear
      break;
    }
...
void Params::clear_step_lambda() {
// @@protoc_insertion_point(one_of_clear_start:Params)
  switch (step_lambda_case()) {
    case kMalaStepLambda: {
      // No need to clear
      break;
    }
    ...
    switch (tag >> 3) {
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 97)) {
          _internal_set_mala_step_means(::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr));
          ptr += sizeof(double);
        } else goto handle_unusual;
        continue;
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 105)) {
          _internal_set_mh_sigma_means(::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr));
          ptr += sizeof(double);
        } else goto handle_unusual;
        continue;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 113)) {
          _internal_set_mala_step_lambda(::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr));
          ptr += sizeof(double);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Params::_InternalSerialize(
  ...
  if (_internal_has_mala_step_means()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(12, this->_internal_mala_step_means(), target);
  }

  // double mh_sigma_means = 13;
  if (_internal_has_mh_sigma_means()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(13, this->_internal_mh_sigma_means(), target);
  }

  // double mala_step_lambda = 14;
  if (_internal_has_mala_step_lambda()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(14, this->_internal_mala_step_lambda(), target);
  }
...
void Params::InternalSwap(Params* other) {
  ...
  swap(step_means_, other->step_means_);
  swap(step_lambda_, other->step_lambda_);
